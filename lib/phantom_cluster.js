...
PhantomCluster.prototype.getStatus = function () {
    return {
        ...
        'totalProcesses': this.getTotalProcesses()
    };
};
...
PhantomCluster.prototype.spawnPhantom = function (phantomInstanceConfig) {

    phantomInstanceConfig = phantomInstanceConfig || Object.create(this._defaultPhantomConfig);
...
PhantomCluster.prototype.getTotalActive = function () {
    ...
    return currentActiveProcesses;
};

PhantomCluster.prototype.getTotalProcesses = function() {
    return Object.keys(this._phantomInstances).length;
};
...
PhantomCluster.prototype._recalibrate = function () {
    ...
    if (currentLoad > this._desiredLoad) {
        ...
        for (var i = 0; i < instancesToSpawn; i++) {
            // selenium 2.41 has issues with too many new
            // phantoms at once, we artificially add delay
            setTimeout(this.spawnPhantom.bind(this), i * 100);
        }
    }
};
